...
 
#=============================================================================
# Arc CSV Cleanup Configuration Script
#
...
# TARGET_DIR="/SIM/DFDS_20211231/Personal/ynie/3-LibCharCerti/2025/N2P_v1.0/2-select_2nd_round/1-FMC_golden/gen_DECKs/"
TARGET_DIR="/SIM/DFDS_20211231/Personal/ynie/3-LibCharCerti/2025/N2P_v1.0/1-MC_golden/0-FMC_golden/gen_DECKs/"
 
...
 
# Available types (comment out lines with # to exclude them)
TYPES=(
    #"delay"
    "hold"
    "mpw"
...
 
if [ -z "$TYPES_STR" ]; then
    echo -e "${RED}ERROR: No types selected!${NC}"
    exit 1
fi
 
# Safety check for cleanup action
#if [ "$ACTION" = "--cleanup" ]; then
#    echo -e "${RED}WARNING: You are about to PERMANENTLY DELETE directories!${NC}"
#    echo -e "${YELLOW}Edit the script to remove this safety check if you're sure.${NC}"
#    exit 1
#fi
 
# Build and execute command
CMD="/usr/local/python/3.9.10/bin/python3 $SCRIPT_NAME --target-dir \"$TARGET_DIR\" --corners \"$CORNERS_STR\" --types \"$TYPES_STR\" $ACTION"
 
