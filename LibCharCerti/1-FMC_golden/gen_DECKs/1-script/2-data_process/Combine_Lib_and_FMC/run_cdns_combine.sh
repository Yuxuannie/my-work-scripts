...
 
set base_dir = "/SIM/DFDS_20211231/Personal/ynie/3-LibCharCerti/2025/N2P_v1.0/1-MC_golden/0-FMC_golden/gen_DECKs/"
set rpt_dir = "${base_dir}/1-script/2-data_process/Combine_data"
set script_dir = "${base_dir}/1-script/2-data_process/Combine_Lib_and_FMC/"
set volts = (0p450v 0p465v 0p480v 0p495v)
#set volts = (0p450v)
 
## Recipe_5
set lib_dir = "/SIM/DFDS_20211231/Personal/ynie/3-LibCharCerti/2025/N2P_v1.0/0-Collateral/ref_libs/Library_QC/"
set run_dir = "${base_dir}/1-script/2-data_process/Combine_data"
 
 
foreach volt ($volts)
    cd $rpt_dir
...
 
                cd $run_dir
                liberate --trio ${script_dir}/run_ldbx.tcl ${script_dir}/Combine_FMC_and_CDNS_lib.py \
