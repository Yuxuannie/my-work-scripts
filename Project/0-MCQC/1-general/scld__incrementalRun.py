...
    # Required arguments
    required_arg_info = [
        ("--sim_path", ":", "The path to the simulation directory containing the "
                            "partial data."),
        ("--nsamples", ":", "The total number of samples that is supposed to be "
                            "simulated.")
    ]
    print("Arguments:")
...
    # Usage
    print("\nUsage examples:")
    print("\tCall the incremental SPICE deck generation flow on a path for a total of "
          "5k samples.")
    print("\t>>> python %s "
