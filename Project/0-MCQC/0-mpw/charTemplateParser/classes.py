...
        return self._define_template_list[
            template_name
        ] if template_name in self._define_template_list else None
 
...
            cell (Cell):
        """
        return self._cell_list[cell_name
                              ] if cell_name in self._cell_list else None
 
 
class DefineTemplateInfo(object):
    def __init__(
        self, type=None, index_1=None, index_2=None, index_3=None, name=None
    ):
        # Common
        self._type = type
